 ...
 *   symlinked `~/.claude/skills/novamira` at it. HQ writes nothing; see
 *   `src/skills/store.ts` for the whole argument. Installation is
 *   `npx skills add <package-root> --skill novamira-hq --global`, which knows
 *   every agent's layout and asks which one.
 *

...
test("signed helper ships inside desktop without granting it JIT exceptions", async () => {
  ...
  assert.match(release, /needs: \[prepare, desktop, desktop-macos\]/);
  assert.match(release, /\.keychain\.zip/);
